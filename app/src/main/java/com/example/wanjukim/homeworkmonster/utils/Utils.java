...
public class Utils {
    ...
    public static final String[] alarms = {"1 day", "2 days", "3 days", "4 days", "5 days", "6 " +
            "days", "a week"};
    public static final SimpleDateFormat dateFormat = new SimpleDateFormat("MMM d, yyyy (E)",
            Locale.ENGLISH);
    ...
    public static void showTopSnackBar(Activity activity, String message) {
        ...
        TextView snackText =
                snackView.findViewById(com.androidadvance.topsnackbar.R.id.snackbar_text);
